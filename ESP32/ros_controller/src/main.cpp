...
public:
  ...
  MotorController(int8_t PwmPin, int8_t DirPin, int8_t EnablePin, int8_t EncoderA, int8_t EncoderB, int tickPerRevolution) {
    this->Pwm = PwmPin;
    this->Dir = DirPin;
...
MotorController leftWheel(L_PWM_PIN, L_DIR_PIN, L_ENA_PIN, L_ENCODER_PINA, L_ENCODER_PINB, tickPerRevolution_LW);
MotorController rightWheel(R_PWM_PIN, R_DIR_PIN, R_ENA_PIN, R_ENCODER_PINA, R_ENCODER_PINB, tickPerRevolution_RW);
